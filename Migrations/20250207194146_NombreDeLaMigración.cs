    ...
    public partial class NombreDeLaMigración : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VentaProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VentaProduct_Ventas_VentaId",
                        column: x => x.VentaId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4b84c972-bfd3-43d1-9498-d49880dbc488", null, "client", "client" },
                    { "68af5ea6-56ab-4b31-aa4c-5196cf8be9cc", null, "seller", "seller" },
                    { "a8afeb89-dde3-4533-86a9-84220b145ab1", null, "admin", "admin" }
                });
